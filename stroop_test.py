...
""")
    ...
    if st.session_state.q_index > TOTAL_QUESTIONS:
        ...
        st.session_state["stroop_mean_rt"] = mean_rt if pd.notna(mean_rt) else 0
        st.session_state["stroop_interference"] = stroop_effect if stroop_effect is not None else 0
