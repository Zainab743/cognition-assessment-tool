...
def run_math_test():
    ...
    if remaining <= 0:
        ...
        if st.session_state.attempted > 0:
            ...
            st.session_state["num_attempted"] = st.session_state.attempted
            st.session_state["num_correct"] = st.session_state.correct_count
            st.session_state["num_speed"] = speed_efficiency
            st.session_state["num_weighted_accuracy"] = weighted_accuracy
